...
(async () => {
    ...
    // Step 6: Remove at least one of the items.
    await page.click('#remove-sauce-labs-fleece-jacket');
    await page.click('#remove-sauce-labs-onesie');
    await page.waitForTimeout(500);

    // Step 7: Click the cart icon to view the checked-out items.
    ...
    // Step 9: Fill in your First Name, Last Name, and ZIP Code.
  ...
  // End result: Successful end-to-end checkout of "Removed At Least One". Removed items: Fleece Jacket and Onesie.